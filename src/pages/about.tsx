  ...
  return (
    <div className="App">
      ...
      <div className="aboutContent">
        ...
        <h3>Colongraph</h3>
        <p>
          The intention behind the building of this site first and foremost was
          for it to feel <em>fun</em>. We believe that computing should be
          playful and take inspiration from those who have advocated for this (
          <a href="https://casholman.com/">Cas Holman</a>,{" "}
          <a href="https://en.wikipedia.org/wiki/Homo_Ludens">Johan Huizinga</a>
          ,{" "}
        ...
        <p>
          All code is{" "}
          <a href="https://github.com/we-bsite/we-bsite/">open-source</a> and we
          welcome ideas, contributions, and extensions. The data is also public.
          Please contact us if you are interested in supporting the project
          through extensions or advocacy.
        </p>
      </div>
      <Footer />
    </div>
